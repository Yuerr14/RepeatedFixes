...
public class AST2TestBase extends BaseTestCase {
	...
	public IASTTranslationUnit parse(String code, ParserLanguage lang, boolean useGNUExtensions) throws ParserException {
    	return parse(code, lang, useGNUExtensions, true);
    }

	public IASTTranslationUnit parse(String code, ParserLanguage lang, boolean useGNUExtensions,
	...
	public static void main(String args[])
	{
		...
		try {
			IASTTranslationUnit tu = ast.parse("", C);
